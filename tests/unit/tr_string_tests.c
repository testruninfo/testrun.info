...
int test_tr_string_free(){
        ...
        assert(NULL == tr_string_free(NULL));

        assert(NULL != string);
        string = tr_string_free(string);
        assert(NULL == string);
...
int test_tr_string_write_embeded(){
        ...
        assert(-1 == tr_string_write_embeded(   NULL,
                                                0,      0, 0,
                                                NULL,   0,
                                                NULL,   0,
                                                NULL,   0,
        ...
        assert(-1  == tr_string_write_embeded(  &data,
                                                &open,  &used, rate,
                                                NULL,   0,
                                                NULL,   0,
                                                NULL,   0,
        ...
        assert( strlen(expect) == tr_string_write_embeded(  &data,
                                                &open,  &used, rate,
                                                NULL,   0,
                                                NULL,   0,
                                                NULL,   0,
...
int test_tr_string_embed(){
        ...
        assert(strncmp(expect, ptr, strlen(expect)) == 0);
        assert(size == TR_STRING_DEFAULT_SIZE + 5);
        ...
        assert(strncmp(expect, ptr, strlen(expect)) == 0);
        assert(size == TR_STRING_DEFAULT_SIZE + 6);
        ...
        assert(strncmp(expect, ptr, strlen(expect)) == 0);
        assert(size == TR_STRING_DEFAULT_SIZE + 10);
...
int test_tr_string_replace_first(){
...
int test_tr_string_replace_all(){
...
int all_tests() {
       ...
       testrun_test(test_tr_string_free);
       testrun_test(test_tr_string_prepare);
       testrun_test(test_tr_string_append);
       testrun_test(test_tr_string_write_embeded);
       testrun_test(test_tr_string_embed);
       testrun_test(test_tr_string_unset_end);
       testrun_test(test_tr_string_replace_first);
       testrun_test(test_tr_string_replace_all);
